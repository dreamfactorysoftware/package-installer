...
class Installer extends LibraryInstaller implements EventSubscriberInterface
{
    ...
    /**
     * @type bool If true, the package installer will work in a hosted environment
     */
    const ALLOW_FABRIC_INSTALLS = true;
    /**
     * @type string
     */
    ...
    {
        if ( !static::ALLOW_FABRIC_INSTALLS && file_exists( static::FABRIC_MARKER ) )
        {
